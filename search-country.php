...
$region=isset($_POST['continent'])? $_POST['continent']:"";
...
$indepyear_min=isset($_POST['surfaceArea_min'])? $_POST['surfaceArea_min']: 0;
$indepyear_max=isset($_POST['surfaceArea_max'])? $_POST['surfaceArea_max']: 0;
...
if($submit==="search"){
    ...
    }else if($indepyear_min )){
        $wheres[]="IndepYear >= {$indepyear_min}";
    }else if($indepyear_max )){
    ...
    <body>
        <form class="container" method="POST" action="search-country.php">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select class="form-Continent" class="col-sm-10"id="Continent" name="Continent">
            ...
            <div class="row mb-3">
                <label for="surfacarea_min" class="col-sm-2 col-form-label">surfacarea</label>
                <div class="col-sm-10">
                    <div class="inout-group">
                        <input type="number" step="0.01" class="form-control" id="surfacarea_min" name="surfacarea_min" value="<?php echo $surfacarea_min; ?>">
                        <div class="input-group-text">~</div>
                        <input type="number" step="0.01" class="form-control" id="surfacarea_max" name="surfacarea_max" value="<?php echo $surfacarea_max; ?>">
                    </div>
                </div>  
            </div>
